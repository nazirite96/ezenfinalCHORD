...
<c:forEach items="${taskList }" var="taskDTO" varStatus="status">
	<!-- 업무명:s -->
	<div class="input-box">
		<input type="text" class="font-bold size-18" placeholder="업무명을 입력하세요." value="${taskDTO.task_title }" readonly>
	</div>
	<!-- 업무명:f -->
	...
	<div class="input-box martop-15">
		<dl>
			...
			<dd>
				<input type="hidden" class="edit-confirm" data-taskno="${taskDTO.task_no }">
				<div class="task-state-list">
	...
	<div class="input-box martop-15 add-item-box">
		<dl>
			...
			<dd class="posi-re">
				<input type="text" placeholder="시작일" value="${taskDTO.task_start_date }" readonly/>
			</dd>
		</dl>
	</div>
	<!-- 시작일:f -->
	...
	<div class="input-box martop-15 add-item-box">
		<dl>
			...
			<dd class="posi-re">
				<input type="text" placeholder="마감일" value="${taskDTO.task_end_date }" readonly/>
			</dd>
		</dl>
	</div>
	<!-- 마감일:f -->
...
$(function(){
	...
	$(".invate-frm-submit").click(function(){
		...
		ptnInviteForm.submit();
				...
				<div>
					<%@include file="../project/layerPopCon.jsp"%>
				</div>
			</main>
		</div>
