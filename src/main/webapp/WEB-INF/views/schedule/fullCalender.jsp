...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="project-wrap">
		<div class='modal fade' id='successModal' tabindex='' role='dialog' aria-labelledby='successModalLabel' aria-hidden='true'>
	 	...
	 	if(invitedSchd.length>0){
		 	for(var i = 0; i<invitedSchd.length; i++){
		 		test.push( {
					...
					,title	: invitedSchd[i].tim_cont
					,start	: invitedSchd[i].time_start_date
	 				,end	: invitedSchd[i].time_end_date
		 			,color	: '#f1c40f'
	 				,schd_loc	: invitedSchd[i].schd_loc
                    ,memo	: invitedSchd[i].schd_memo
                    ,st		: invitedSchd[i].time_start_date
                    ,ed		: invitedSchd[i].time_end_date
	...
	request.fail(function( jqXHR, textStatus ) {
		...
		function view(loc){
			...
			function placesSearchCB (data, status, pagination) {
			    ...
			    map.relayout();
			    map.setCenter(map.setBounds(bounds));
			}
